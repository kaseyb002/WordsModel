...
public enum BoardSquare: Equatable, Codable {
    ...
    public static func standardBoard() -> [[BoardSquare]] {
        ...
        var board = Array(repeating: Array(repeating: BoardSquare.empty, count: 15), count: 15)
        
        // Triple word scores (corners and edges)
        let tripleWordPositions = [
            (0, 0), (0, 7), (0, 14),
            (7, 0), (7, 14),
            (14, 0), (14, 7), (14, 14)
        ]
